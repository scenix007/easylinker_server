...
ssserver -s 0.0.0.0 -p 9309 -k 532906018@qq.com  -m aes-128-cfb --fast-open --user nobody --pid-file /tmp/ss.9309 --log-file log/log.9309 -q -d start
...
ssserver -s 0.0.0.0 -p 9337 -k thank@angus  -m aes-128-cfb --fast-open --user nobody --pid-file /tmp/ss.9337 --log-file log/log.9337 -q -d start
...
ssserver -s 0.0.0.0 -p 443 -k router@udp  -m aes-128-cfb --fast-open --user nobody --pid-file /tmp/ss.443 --log-file log/log.443 -q -d start
...
ssserver -s 0.0.0.0 -p 9330 -k 18535652@qq.com  -m aes-128-cfb --fast-open --user nobody --pid-file /tmp/ss.9330 --log-file log/log.9330 -q -d start
