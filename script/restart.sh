...
nohup ss-server -s 0.0.0.0 -p 9326 -k aaron@ibreathcare.com -m aes-128-cfb -u --fast-open >> log/log.9326 2>&1 &
...
nohup ss-server -s 0.0.0.0 -p 9327 -k hans@ibreathcare.com -m aes-128-cfb -u --fast-open >> log/log.9327 2>&1 &
